  ...
  return (
    ...
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            ...
            <Image src={Logo} alt="company-logo" width="80px" height="80px" className="cursor-pointer" />
            </Link>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© <a href="https://printlivepro.com" className="hover:underline">PrintLivePro™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            {/* <a href="https://www.facebook.com/printlivepro" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.instagram.com/printlivepro" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://twitter.com/printlivepro" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
